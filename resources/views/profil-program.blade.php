        ...
        <div class="grid grid-cols-1 gap-5">
            ...
            @foreach (['A', 'B', 'C', 'D'] as $item)
                ...
                <div class="flex items-start justify-between my-4">
                    <div>
                        <div class="font-bold text-lg mb-3">{{ $item }}. Lorem ipsum dolor sit amet consectetur adipisicing elit.</div>
                        <div class="text-sm">
                            <ol class="space-y-2">
                                <ul>a. Lorem ipsum dolor, sit amet consectetur adipisicing elit. In, vero?</ul>
                                <ul>b. Lorem ipsum dolor, sit amet consectetur adipisicing elit. In, vero?</ul>
                                <ul>c. Lorem ipsum dolor, sit amet consectetur adipisicing elit. In, vero?</ul>
                            </ol>
                        </div>
                    </div>
                </div>
