...
class DataSekolah {
    ...
    public static function get() 
    {
        return [
            ...
            'beranda' => [
                'banners' => [
                    asset('images/banners/banner 1.jpg'),
                    asset('images/banners/banner 2.jpg'),
                    asset('images/banners/banner 3.jpg'),
                    asset('images/banners/banner 4.jpeg'),
                ],
                "kepsekName" => "Khairullah",
                "sambutanText" => 'Sambutan Kepala SMAN 1 Tambang

                Assalamualaikum Warahmatullahi Wabarakaatuh.
                Salam sejahtera dan tetap semangat. Selamat datang di website SMAN 1 Tambang
                Sebagai media informasi dan komunikasi web SMAN 1 Tambang dibangun dan dikembangkan dalam rangka meningkatkan layanan sekolah kepada peserta didik, orang tua, masyarakat dan stakeholder. Kualitas layanan menjadi salah satu misi sekolah dan kaitannya dengan transparansi dan akuntabilitas sekolah. Melaksanakan amanah sebagai pimpinan di SMAN 1 Tambang, harapan untuk menjadikan sekolah besar dengan bertabur prestasi baik akademik maupun non akademik terus meningkat. Sekolah yang akan melahirkan generasi yang kreatif, inovatif, religius yang berwawasan lingkungan serta mengabdi kepada bangsa dan negara. Mendorong terus berkembangnya inovasi dan kreasi warga sekolah. Meningkatkan kekeluargaan dan kerjasama dengan seluruh komponen berlandaskan semangat 5S (senyum, sapa, salam, sopan dan santun). Dari lubuk hati yang dalam, saya mengajak seluruh warga sekolah,orang tua, masyarakat dan stakeholder, marilah kita bergandeng tangan dan berkolaborasi untuk menciptakan sekolah yang nyaman, aman dan menyenangkan bagi putra-putri kita dalam menuntut ilmu. Tetap mempertahankan image SMAN 1 Tambang sebagai sekolah unggulan baik di Tambang maupun Indonesia serta "Sekolah tempat kunjungan/rujukan sekolah lain dari seluruh Indonesia" karena keunggulan yang telah dimiliki, sekolah penyelenggara Sistem Kredit Semester (SKS), pelayanan bagi peserta didik yang memiliki potensi untuk menyelesaikan pendidikan di SMA selama 4 semester, dan adaptasi kurikulum dan penilaian melalui kerjasama dan afiliasi dengan University Of Cambridge International Examination dalam melaksanakan ujian internasional pada tingkat IGCSE dan As/A Level. Hingga pada akhirnya mencapai visi sekolah yang berprestasi hingga tingkat dunia.

                Semoga Allah SWT meridhoinya dan masyarakat dapat mengambil manfaat yang sebesar-besarnya dengan segala usaha dan upaya SMA Negeri 1 Tambang.
            ...
            'berita' => [
                "1" => [
                    "title" => "SMAN 1 Tambang Seleksi Siswa Untuk Ikuti Lomba Tahfiz Tingkat Riau.",
                    "body" => 'KANALSUMATERA.com - Kampar - Luar biasa, itulah kata-kata yang melekat pada siswa SMAN 1 Tambang yang mengikuti seleksi lomba Tahfiz tingkat Provinsi Riau.
        
                    Seleksi Tahfiz 3 Juz yang dilihat langsung oleh Kepsek Khairullah MPd itu menjadi penyemangat bagi siswa dalam mengikuti proses tersebut.
                    
                    "Alhamdulillah MKKS tingkat SMA siap mengikuti lomba Tahfiz tingkat Riau termasuk SMAN 1 Tambang" kata Khairullah kepada media Kamis (02/10/2020).
                    
                    Dari informasi yang dihimpun bahwa SMA model Tambang mengirimkan dua orang yakni 3 Juz dan 7 Juz.
                    Semuanya dalam pembinaan sekolah dan berkat disipilin siswa dan orang tua.
                    
                    Memang agak terkejut ketika kita mendengar lantunan ayat demi ayat yang dibacakan oleh siswa ini. Karena sebagai sekolah dengan basic umum tentunya tidak terlalu banyak yang di pelajari tentang agama. Apalagi hafalan, tetapi ternyata berbeda dengan SMAN ini yang mana sudah sejak lama menghafal Al-Quran melalui program yang dicetuskan oleh sang Kepsek.
        
                    Khairullah menceritakan bahwa program sekolah yakni One day One Ayat. Atas dasar itulah memudahkan para siswa untuk menghafal.
        
                    "Meskipun sekolah umum tapi visi misi kami para guru adalah menciptakan generasi muda yang handal dan memiliki akhlak baik sebagai manusia." tutupnya. Hend',
                    "image_url" => asset('images/Berita/berita-1.jpg')
                ],
                "2" => [
                ...
                "3" => [
                    ...
                    "body" => 'Serda Abdul Wachid Babinsa Ramil 07/Kampar menyampaikan, bahwa materi yang diberikan materi Empat Pilar Kebangsaan yaitu, yaitu Pancasila, UUD 1945, Bhinneka Tunggal Ika dan NKRI serta melatih kedisiplinan melalui latihan baris berbaris. Hal ini sesuai ketentuan kegiatan non fisik TMMD ke-105 Kodim 0313/KPR Tahun 2019.
                    Dalam pemaparannya juga, Serda Abdul Wachid mengingatkan para pelajar SMAN 1 Tambang tentang betapa pentingnya peran pemuda/pemudi dalam menjaga keutuhan NKRI terhadap bahaya acaman yang dihadapi sekarang ini.
                    "Bahwa generasi muda Indonesia harus dijaga dan dibentuk rasa nasionalismenya terhadap bangsa dan negaranya, sehingga budaya, pola pikir, dan tindakan yang bertentangan dengan nilai-nilai Pancasila yang datangnya dari luar bisa dihempang dan dikikis habis," ujarnya.',
                    'image_url' => asset('images/Berita/berita-3.webp')
                ],
                "4" => [
                    "title" => "DPRD Riau Minta Pemerintah Perhatikan Nakes di Tengah Kondisi Pandemi yang Sulit",
                    "body" => 'KANALSUMATERA.com - Pekanbaru– Bertambahnya kasus Covid-19 di Provinsi Riau, membuat Tenaga Kesehatan (Nakes) memerlukan tenaga yang ekstra dalam penanggulangan Covid-19.
                    ...
                    ',
                    "image_url" => asset('images/Berita/berita-4.jpg')
                ],
                "5" => [
                    "title" => "Mahasiswa Tambang Gelar Aksi Penggalangan Dana Untuk Palestina",
                    "body" => '
        
                    KANALSUMATERA.com - Tambang - Ikatan Mahasiswa Kecamatan Tambang kembali melakukan aksi solidaritas penggalangan dana untuk Palestina di pasar-pasar yang ada di Kecamatan Tambang salah satunya pasar yang ada di Desa Terantang dan Desa Tambang.
                    
                    Aksi mereka mendapat antusias dari masyarakat Kecamatan Tambang. Salah seorang pengunjung pasar di Desa Tambang mengatakan bahwa selalu melakukan agenda yang bersifat positif berdiri dan berkembang di tengah masyarakat. "Hanya ini yang dapat kita berikan untuk saudara-saudara kita di Palestina, setidaknya dengan sedikit tindakan yang dilakukan insya Allah akan bermanfaat untuk saudara-saudara Palestina nantinya" tutur pengunjung tersebut.
                    
                    Dalam penggalan dana yang dipimpin langsung oleh Ikhwansyah selaku ketua IMKT, berharap mahasiswa tetap jaga semangat untuk membangun desa dan tidak lupa jaga kekompakan untuk ke depannya lagi sesuai dengan janji kita ketika pelantikan sebagai promotor sekaligus tangan rakyatnya masyarakat Kecamatan Tambang.
                    
                    Dan tidak lupa pula beliau mengucapkan terima kasih kepada seluruh masyarakat Kecamatan Tambang yang telah mendukung agenda Ikatan Mahasiswa Kecamatan Tambang. "Salah satunya dalam aksi solidaritas penggalangan dana untuk Palestina ini" tutur pria asal Terantang ini. ***
                    ',
                    "image_url" => asset('images/Berita/berita-5.jpg')
                ],
                "6" => [
                    "title" => "Bantu Guru Dalam Proses Pembelajaran Daring Selama Covid, Prodi PBSI FKIP UIR Gelar Literasi Digital di SMAN 1 Tambang Kampar",
                    "body" => 'PEKANBARU - Penyebaran virus Covid-19 yang sangat masif mengubah segala tatanan kehidupan manusia. Dunia pendidikan merupakan satu di antara sekian banyak aspek kehidupan yang mengalami dampak dari penyebaran virus Covid-19.
        
                    Kebijakan untuk melaksanakan proses pembelajaran jarak jauh ternyata tidak begitu saja bisa dilaksanakan oleh guru dan perangkat sekolah lainnya. 
                    
                    Peralihan aktivitas pembelajaran lansung ke pembelajaran daring ternyata cukup membingungkan bagi guru. Guru ditantang untuk mampu menggunakan teknologi dalam menjalankan tugas-tugasnya. Literasi digital para guru menjadi hal yang sangat penting dalam pelaksanaan pembelajaran daring.
                    
                    Untuk membantu guru dalam melaksanakan kegiatan pembeajaran di sekolah, program studi Pendidikan Bahasa dan Sastra Indonesia FKIP UIR melaksanakan kegiatan Pengabdian kepada Masyarakat (PkM) di SMAN 1 Tambang. 
                    
                    Kegiatan PkM yang diketuai oleh Dr.Fatmawati, S.Pd., M.Pd. ini mengusung judul ‘Literasi Digital pada Masa Pandemi Covid-19 di SMAN 1 Tambang: Pemanfaatan Akun Google dalam Proses Pembelajaran Daring”. 
                    
                    Kegiatan PkM ini dilaksanakan pada hari, Jumat, 26 Maret 2021 lalu yang dihadiri lebih dari 40 orang guru. 
                    
                    Sasaran kegiatan ini adalah para guru SMAN 1 Tambang. Tujuannya adalah untuk  meningkatkan kesadaran para guru pentingnya literasi digital dalam proses pembelajaran daring.
                    
                    "Selain itu, melalui kegiatan PkM ini diharapkan bisa memberikan pemahaman kepada guru tentang pemanfaatan akun google (google classroom, google meet, dan google formulir) dalam proses pembelajaran daring," Pungkas Fatmawati
         
                    Kepala SMAN 1 Tambang, Drs. Khairullah, M.Pd., menyambut baik kegiatan PkM yang ditaja oleh program studi Pendidikan Bahasa dan Sastra Indonesia FKIP UIR ini. 
        
                    Beliau juga menekankan bahwa kegiatan serupa harus lebih sering dilaksanakan di sekolah yang beliau pimpin. Hal tersebut direspon positif oleh Dr. Fatmawati, S.Pd., M.Pd. selaku ketua kegiatan PkM.
        
                    Fatmawati menyatakan program studi Pendidikan Bahasa dan Sastra Indonesia FKIP UIR selalu meningkatkan kerja sama dengan sekolah-sekolah yang ada di provinsi Riau dalam upaya meningkatkan mutu pendidikan di Provinsi Riau.(***)
                    ',
                    "image_url" => asset('images/Berita/berita-6.jpg')
                ],
                "7" => [
                    "title" => "Unggul di Kampar, SMAN 1 Tambang Optimis Raih Penghargaan Adiwiyata Tingkat Nasional",
                    "body" => 'Wakil Kepala Sekolah Bidang Kesiswaan SMAN 1 Tambang, Drs. Nasrial mengatakan, untuk mewujudkan cita-cita tersebut, pihak sekolah terus berbenah dalam bidang lingkungan dengan harapan kedepan sekolah ini mampu bersaing dan unggul dalam bidang prestasi.
                    Alhamdulillah, kami SMAN 1 Tambang berhasil meraih penghargaan tingkat Kabupaten Kampar, dan terakhir tingkat Provinsi Riau. Pencapaian ini membuat kami merasa optimis mendapat penghargaan tingkat nasional yang akan diumumkan pada Desember 2015 mendatang," kata Nasrial didampingi sejumlah staf ditemui GoRiau.com, Sabtu (30/5/2015).
                    Nasrial menjelaskan, keberhasilan SMAN 1 Tambang meraih Adiwiyata tidak terlepas dari kerjasama tenaga didik dan siswa serta lingkungan. Dengan motto LISAMBIL (Lihat Sampah Ambil), warga sekolah sangat peduli dalam usaha menjaga lingkungan bersih, asri dan nyaman.
                    Tidak hanya itu, untuk pendidikan lapangan, SMAN 1 Tambang juga mendirikan pojok taman, kebun hyroponix, budidaya lebah madu dan pengolahan limbah air wudhu menjadi kolam ikan. "Dalam keseharian, kami juga membiasakan siswa dan guru untuk peduli, misalnya hemat dalam penggunaan air," sambungnya. 
                    ',
                    'image_url' => asset('images/Berita/berita-7.webp')
                ]
            ],
            ...
            'kegiatan' => [
                "1" => [
                    ...
                    Kemudian dilanjutkan dengan amanat pembina upacara yang disampaikan oleh kepala sekolah selaku pembina upacara. Dalam amanatnya, kepala sekolah menghimbau agar program ekstrakurikuler ini dapat berjalan dengan maksimal sesuai dengan yang diharapkan dan seluruh siswa anggota ekskul dapat mengasah dan mengembangkan bakatnya sesuai dengan ekstrakurikuler yang dipilihnya.
                    
                    Acara selanjutnya adalah acara pengukuhan yang diadakan pada pukul 20.30 WIB. Siswa-siswi anggota ekskul mendirikan tenda-tenda di lapangan sekolah.
                    
                    Acara pengukuhan ini di awali seremonial yakni unggun api, turut hadir dalam acara tersebut: kepala sekolah, para pembina ekskul dan juga majelis guru serta pegawai TU. Acara itu disemarakkan dengan penampilan kreativitas seperti persembahan tari, menyanyi dan sebagainya.
                    
                    Acara ditutup dengan silaturahim dan keakraban antar anggota ekskul.',
                    "image_url" => asset('images/Kegiatan/kegiatan-1.jpg'),
                ...
                "2" => [
                    ...
                    Kanit Dikyasa Satlantas Polres Kampar AIPTU Junaydi SE saat dikonfirmasi menyampaikan, bahwa kegiatan ini bertujuan memberikan pengetahuan dan pemahaman tentang tertib berlalulintas kepada para pelajar.
                    
                    Diharapkan dengan sosialisasi ini dapat meningkatkan kesadaran dan kepatuhan masyarakat khususnya kalangan pelajar dalam berlalulintas, tentunya hal ini juga akan berkontribusi untuk menekan angka kecelakaan lalulintas, ungkapnya.',
                    "image_url" => asset('images/Kegiatan/kegiatan-2.jpg'),
                ...
                "3" => [
                    ...
                    "image_url" => asset('images/Kegiatan/kegiatan-3.jpeg'),
                    "created_at" => "07 Agustus 2019"
                ],
                "4" => [
                    ...
                    "image_url" => asset('images/Kegiatan/kegiatan-4.jpg'),
                ...
                "5" => [
                    ...
                    Selanjutnya Arahan dari Kapolres Kampar AKBP Andri Ananta Yudhistira SIK, MH, dengan materi tentang Etika berlalulintas, Kebhinekaan, Bahaya Narkoba dan dampak media sosial.
                    
                    Kapolres Kampar juga memberikan motivasi kepada para pelajar agar menjadi siswa berprestasi dan disiplin, agar kelak menjadi orang yang sukses.
                    
                    Disampaikan Kapolres bahwa masa depan bangsa Indonesia ditentukan oleh generasi muda saat ini, untuk itu perlu pembinaan bagi generasi muda untuk menyelamatkan masa depan bangsa.
                    
                    Kapolres juga berinteraksi dengan para siswa dan memberikan pertanyaan kepada mereka, bagi yang menjawab dengan benar diberikan cenderamata yang disediakan oleh Kapolres, Cendera Mata ini juga diberikan untuk sekolah yang diserahkan langsung melalui Kepala Sekolah.
                    ...
                    ',
                    "image_url" => asset('images/Kegiatan/kegiatan-5.jpeg'),
                ...
                "6" => [
                    ...
                    Siswa terlihat antusias dan aktif dalam mengikuti kegiatan ini terutama saat melakukan simulasi-simulasi yang berkaitan dengan materi yang disampaikan diantaranya adalah simulasi bagaimana seorang pemimpin bisa mengambil keputusan dengan cepat dan bagaimana sebuah tim melakukan kerja sama yang efisien dan efektif serta bagaimana membangun sebuah tim yang super.
                    
                    Kegiatan diakhiri dengan pengumuman peserta terbaik LDKS tahun 2016 yang putra di raih oleh Muhamad Aldino dan yang putri diraih oleh Ikhwana Yumsi. (rls)',
                    "image_url" => asset('images/Kegiatan/kegiatan-6.webp'),
            ...
            'pengumuman' => [
                "1" => [
                    "title" => 'INFORMASI DAFTAR SEMENTARA DAN TEHNIS TES MUTASI TAPEL 2021/2022',
                    "body" => 'Assalamualaikum Wr.Wb,
                    Selamat Siang, dan Salam Sejahtera Semua
                    
                    Semoga kita semua dalam keadaan sehat dan dalam lindungan Allah SWT, Tuhan Yang Maha Kuasa.
                    
                    Bapak ibu orang tua/wali dan peserta mutasi, beberapa informasi kami sampaikan sbb;
                    
                    1. Selasa, 13 Juli 2021, pukul 12.00 WIB daftar sementara dan pukul 16.00 WIB akan diumumkan daftar nama2 peserta MUTASI baik di website dan di grup WA.
                    
                    2. Selasa, 13 Juli 2021, pukul 16.00 kami undang orang tua/wali atau peserta didik (salah satunya) untuk ikut pengarahan link zoom dan setelahnya peserta memgikuti uji sistem/simulasi tes sekitar 15 s.d 20 menit.
                    3. Berikut daftar sementara peserta mutasi.
                ...
                "2" => [
                    "title" => 'INFORMASI PERSYARATAN PENDAFTARAN MUTASI TAPEL 2021/2022',
                    "body" => 'INFORMASI PERSYARATAN PENDAFTARAN MUTASI TAPEL 2021/2022
                    Kepada, Calon peserta MUTASI
                    Kepada,
                    Peserta Mutasi.
                    
                    Dengan ini disampaikan untuk pendaftaran cukup dg:
                    
                    1. Scanning pdf Raport yg ada nilai
                    pengetahuan dan
                    ketrampilan.(Raport ini
                    harus sesuai dengan
                    aslinya)
                    
                    2. Scanning pdf Surat Pertanggung
                    Jawaban Mutlak (SPJM)
                    materai 1000 seperti
                    contoh pada lampiran.
                    
                    3. Berkas asli scanning pdf
                    akan dikumpulkan setelah
                    peserta dinyatakan
                    LULUS.
                    
                    Demikian informasinya dan terima kasih.
                ...
                "3" => [
                    "title" => 'Pengumuman Upacara 2 Mei 2021',
                    "body" => 'Pengumuman

                    Diberitahukan dengan hormat kepada seluruh siswa-siswi SMAN 1 Tambang diharap mengikuti
                    upacara bendera dalam rangka memperingati hari pendidikan nasional yang akan dilaksanakan
                    pada:
                    
                    Hari/Tanggal	: Sabtu, 2 Mei 2021
                    Jam		: 07.30-Selesai
                    Tempat		: Lapangan Sekolah
                    Seragam		: Seragam merah-putih, lengkap dengan topi dan dasi
                    
                    Mohon hadir tepat waktu dan setelah selesai upacara dapat mengisi daftar hadir di unit
                    kesiswaan.
                ...
                "4" => [
                    "title" => 'Pengumuman Kelulusan 02 Mei 2021',
                    "body" => 'Pengumuman

                    Pengumuman kelulusan siswa kelas XIII tahun pelajaran 2020/2021
                    dilaksanakan pada hari sabtu 02 Mei 2021 pada pukul 14.00 WIB.
                    Bagi siswa kelas XII yang berurusan ke sekolah harus mengikuti PSBB yaitu:
                    a. Berpakaian sekolah
                    b. Mencuci tangan sebelum masuk lokasi sekolah
                ...
                "5" => [
                    "title" => 'Pengumuman Upacara 17 Agustus 2021',
                    "body" => 'Pengumuman

                    Diberitahukan dengan hormat kepada seluruh siswa-siswi SMAN 1 Tambang diharap mengikuti
                    upacara bendera dalam rangka memperingati hari kemerdekaan Indonesia yang akan dilaksanakan
                    pada:
            ...
            // PRESTASI SEKOLAH
            'prestasi-sekolah' => [
                [ "Lolos OSN Matematika Tingkat Sudin Pendidikan Wilayah II Kabupaten Kampar" ,"Kabupaten/Kota" ,"2019" ],
                [ "Lolos OSN Fisika Tingkat Sudin Pendidikan Wilayah II Kabupaten Kampar" ,"Kabupaten/Kota" ,"2018" ],
                [ "Lolos OSN Biologi Tingkat Sudin Pendidikan Wilayah II Kabupaten Kampar" ,"Kabupaten/Kota" ,"2018" ],
                [ "Lolos OSN Kebumian Tingkat Sudin Pendidikan Wilayah II Kabupaten Kampar" ,"Kabupaten/Kota" ,"2018" ],
                [ "Lolos OSN Geografi Tingkat Sudin Pendidikan Wilayah II Kabupaten Kampar" ,"Kabupaten/Kota" ,"2018" ],
                [ "Lolos OSN Ekonomi Tingkat Sudin Pendidikan Wilayah II Kabupaten Kampar" ,"Kabupaten/Kota" ,"2018" ],
                [ "Juara 2 The 12th National Foklore Festival Universitas Riau" ,"Propinsi" ,"2017" ],
                [ "Lolos OSN FisikaTingkat Provinsi Riau" ,"Propinsi" ,"2017" ],
                [ "Lolos OSN KebumianTingkat Provinsi Riau" ,"Propinsi" ,"2017" ],
                [ "Lolos OSN Geografi Tingkat Provinsi Riau" ,"Propinsi" ,"2017" ],
                [ "Lolos OSN Ekonomi Tingkat Provinsi Riau" ,"Propinsi" ,"2017" ],
                [ "Lolos Debat Bahasa Inggris Tingkat Sudin Pendidikan Wilayah II Kabupaten Kampar" ,"Kabupaten/Kota" ,"2015" ],
                [ "Juara Harapan 2 OSN Kebumian Tingkat Sudin Pendidikan Wilayah II Kabupaten Kampar" ,"Kabupaten/Kota" ,"2015" ],
                [ "Juara 3 OSN Kebumian Tingkat Sudin Pendidikan Wilayah II Kabupaten Kampar" ,"Kabupaten/Kota" ,"2014" ],
                [ "Juara 3 Olimpiade Guru Nasional (OGN) Bahasa Inggris" ,"Kabupaten/Kota" ,"2014" ],
                [ "Finalis Kepala Sekolah Berprestasi Kabupaten Kampar" ,"Kabupaten/Kota" ,"2012" ],
            ],
            ...
            'guru-and-staff' => [
                [
                    "name" => "MANSUR",
                    "lahir" => "KAMPAR, 1955-05-25",
                    "nuptk" => "1857733634200032",
                    "nip" => "195505251981031014",
                    "jabatan" => "Wakil Kepala Sekolah",
                    "tgl_ditugaskan" => "2014-07-09",
                    "nomor" => "422.2 / SMAN. 1. TB / 2014 / 133",
                    "image_url" => asset('images/Foto guru dan struktur organisasi/Mansur.jpg')
                ],
                [
                    "name" => "NASRIAL",
                    "lahir" => "PAYAKUMBUH, 1955-12-11",
                    "nuptk" => "3543733635200023",
                    "nip" => "195512111987031002",
                    "jabatan" => "Wakil Kepala Sekolah",
                ...
                [
                    "name" => "SYAHRUMAN",
                    "lahir" => "RUMBIO, 1969-12-20",
                    "nuptk" => "5552747650200033",
                    "nip" => "196912202000121002",
                    "jabatan" => "Wakil Kepala Sekolah",
                    "tgl_ditugaskan" => "2006-06-28",
                    "nomor" => "182/424.1/2006",
                    "image_url" => asset('images/Foto guru dan struktur organisasi/syahruman.JPG')
                ],
                [
                    "name" => "IDRIS JAAFAR",
                    "lahir" => "KAMPAR, 1955-04-28",
                    "nuptk" => "3760733634200002",
                    "nip" => "195504281980031004",
                    "jabatan" => "Wakil Kepala Sekolah",
                    "tgl_ditugaskan" => "2014-07-09",
                    "nomor" => "422.2 / SMAN. 1. TB / 2014 / 133",
                    "image_url" => asset('images/Foto guru dan struktur organisasi/idris jaafar.jpg')
                ],
                [
                    "name" => "MULIATI",
                    "lahir" => "TAMBANG, 1975-06-02",
                    "nuptk" => "3934753656300012",
                    "nip" => "197506022007012003",
                    "jabatan" => "Kepala Laboratorium",
                    "tgl_ditugaskan" => "2009-07-14",
                    "nomor" => "422.2/SMAN.1 TB/181",
                    "image_url" => asset('images/Foto guru dan struktur organisasi/muliati.jpg')
                ],
                [
                    "name" => "NELVIA FITRIATI",
                    "lahir" => "KAMPAR, 1966-02-23",
                    "nuptk" => "5555744647300022",
                    "nip" => "196602231994032007",
                    "jabatan" => "Kepala Laboratorium",
                    "tgl_ditugaskan" => "2009-07-14",
                    "nomor" => "422.2/SMAN.1 TB/181",
                    "image_url" => asset('images/Foto guru dan struktur organisasi/nelvia fitriati.jpg')
                ],
                [
                    "name" => "MASNIARI",
                    "lahir" => "KOTA TENGAH, 1966-02-25",
                    "nuptk" => "2557744646300052",
                    "nip" => "196602251995122001",
                    "jabatan" => "Kepala Laboratorium",
                    "tgl_ditugaskan" => "2009-07-14",
                    "nomor" => "422.2/SMAN.1 TB/181",
                    "image_url" => asset('images/Foto guru dan struktur organisasi/masniari.jpg')
                ],
                [
                    "name" => "DARNIS",
                    "lahir" => "DANAU BINGKUANG, 1974-04-04",
                    "nuptk" => "0736752654300072",
                    "nip" => "197404042005012011",
                    "jabatan" => "Kepala Laboratorium",
                    "tgl_ditugaskan" => "2015-01-05",
                    "nomor" => "422.2/SMAN 1TB/007",
                    "image_url" => asset('images/Foto guru dan struktur organisasi/darnis.jpg')
                ],
                [
                    "name" => "SARMUJI",
                    "lahir" => "KAMPUNG WONOSARI, 1965-12-15",
                    "nuptk" => "4547743644200023",
                    "nip" => "131559096",
                    "jabatan" => "Kepala Tata Usaha",
                    "tgl_ditugaskan" => "1985-12-18",
    ...
    public static function getMockup()
    {
        $dummy_berita = [
            "title" => "Lorem ipsum dolor sit, amet consectetur adipisicing.",
            "body" => 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Est nesciunt praesentium aliquid architecto! Nisi quas repudiandae qui magnam optio voluptate!
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda corporis expedita amet quam numquam ratione tempora natus sunt pariatur repellendus.
        
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Doloremque earum quas totam voluptates numquam porro!
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime, atque commodi. Nemo, adipisci quaerat alias vitae numquam incidunt explicabo velit.
            ...
            ',
            "image_url" => asset('images/gray.png')
        ];
        ...
        $dummy_prestasi = [ "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Praesentium, ut!" ,"Kabupaten/Kota" ,"2019" ];
        
        $dummy_guruAndStaff = [
            "name" => "Lorem",
            "lahir" => "KAMPAR, 1996-05-25",
            "nuptk" => "1234567890",
            "nip" => "1234567890",
            "jabatan" => "Jabatan",
            "tgl_ditugaskan" => "2014-07-09",
            "nomor" => "xxx.x / SMAN. 1. TB / xxxx / xxx",
            "image_url" => asset('images/gray.png')
        ];

        $loremDesc = 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Est nesciunt praesentium aliquid architecto! Nisi quas repudiandae qui magnam optio voluptate!
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda corporis expedita amet quam numquam ratione tempora natus sunt pariatur repellendus.
        ...
        return [
            ...
            'beranda' => [
                'banners' => [
                    asset('images/gray.png'),
                    asset('images/gray.png'),
                    asset('images/gray.png'),
                ],
                "kepsekName" => "Name",
                "sambutanText" => $loremDesc
            ],
